...
export function Step4Done({
  ...
  return (
    <div className="space-y-8 text-center">
      ...
      {/* Summary Card */}
      <div className="bg-linear-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200 p-6 space-y-5 text-left">
        {/* Organisation */}
        ...
        {structure === "VARIABLE" && inviteCode && (
          <div className="bg-white rounded-lg p-4 border border-blue-200">
            ...
            <p className="font-mono text-2xl font-bold text-blue-600 tracking-wider break-all">{inviteCode}</p>
          </div>
        )}
      </div>
      ...
      <button
        ...
        className="w-full px-4 py-3.5 bg-blue-600 text-white font-semibold rounded-lg border-b-4 border-blue-800 shadow-md hover:bg-blue-500 active:border-b-2 active:translate-y-0.5 transition-all mt-6"
      >
        Go to Dashboard
      </button>
    </div>
